...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Dk Music")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/OpQueenbots/Dk-Music")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Kalakar_Sangram")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+nHKcQkrsSVEzM2U1")
